...
export const TOOLS = [
  ...
  // ──────────────── Emoji ────────────────
  { id: 'emojify', label: 'Emojify', description: 'Add contextual emojis to your text based on emotions and concepts', icon: '😀', color: 'amber', group: 'ai_writing', tabs: ['writing', 'ai'], type: 'ai', handlerKey: 'handleEmojify', keywords: ['emoji', 'emojify', 'emotion', 'smiley', 'react', 'face'] },
