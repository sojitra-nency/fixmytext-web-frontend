...
const sampleTools = [
  { id: 'uppercase', label: 'UPPERCASE', description: 'Convert to uppercase', icon: 'UC', color: 'violet', group: 'case', tabs: ['all', 'transform'], type: 'api' },
  { id: 'lowercase', label: 'lowercase', description: 'Convert to lowercase', icon: 'lc', color: 'violet', group: 'case', tabs: ['all', 'transform'], type: 'api' },
  { id: 'fix_grammar', label: 'Fix Grammar', description: 'AI grammar fix', icon: 'FG', color: 'pink', group: 'ai_writing', tabs: ['all', 'ai', 'writing'], type: 'ai' },
  { id: 'base64', label: 'Base64 Encode', description: 'Encode to base64', icon: 'B6', color: 'teal', group: 'encoding', tabs: ['all', 'encode'], type: 'api' },
]
...
describe('ToolPanel', () => {
  ...
  it('filters tools by activeTab', () => {
    const writingTools = [
      { id: 'fix_grammar', label: 'Fix Grammar', icon: 'FG', color: 'pink', group: 'ai_writing', tabs: ['writing', 'ai'], type: 'ai' },
      { id: 'uppercase', label: 'UPPERCASE', icon: 'UC', color: 'violet', group: 'case', tabs: ['transform'], type: 'api' },
    ]
  ...
  it('does not mark drawer type tools as disabled when disabled=true', () => {
    const tools = [
      { id: 'find_replace', label: 'Find & Replace', icon: 'FR', color: 'teal', group: 'cleanup', tabs: ['all'], type: 'drawer', panelId: 'find' },
    ]
