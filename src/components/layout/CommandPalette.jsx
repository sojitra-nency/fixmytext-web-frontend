          ...
          >
            ...
            <div className="tu-palette-results" ref={resultsRef}>
              {results.length === 0 && search.query && (
                <div className="tu-palette-empty">
                  No tools found for &quot;{search.query}&quot;
                </div>
              )}
              {results.map((tool, i) => (
                <motion.button
                ...
                >
                  <span
                    className={`tu-palette-item-icon tu-tool-card--${tool.color} tu-tool-card-icon`}
                  >
                    {tool.icon}
                  </span>
                  ...
                  {tool.tabs?.[0] && <span className="tu-palette-item-tag">{tool.tabs[0]}</span>}
                </motion.button>
              ))}
            </div>
