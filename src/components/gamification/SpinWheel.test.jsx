...
describe('SpinWheel', () => {
  ...
  it('shows recent spins history', () => {
    const sub = {
      ...
      spinHistory: [
        ...
        { spin_date: '2024-12-30', reward_type: 'pass', reward_ref: 'Quick Fix', iso_week: '2024-W52' },
      ],
    }
    render(<SpinWheel subscription={sub} isAuthenticated={true} />)
  ...
  it('shows pass reward label in history', () => {
    const sub = {
      ...baseSub,
      spinHistory: [
        { spin_date: '2025-01-01', reward_type: 'pass', reward_ref: 'Quick Fix', iso_week: '2025-W01' },
      ],
    }
    render(<SpinWheel subscription={sub} isAuthenticated={true} />)
