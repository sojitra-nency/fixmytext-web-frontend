...
const HOW_IT_WORKS = [
  ...
  },
  {
    step: '02',
    title: 'Pick a tool',
    desc: 'Browse categories in the sidebar or search with the command palette (Ctrl+K).',
  },
  {
    step: '03',
    title: 'Get results',
    desc: 'See instant output. Accept, copy, or export in one click.',
  },
];
    ...
    <div className="about-page">
      ...
      <nav className="about-nav">
        ...
        <div className="about-nav-links">
          <a href="#features" className="about-nav-link">
            Features
          </a>
          <a href="#how" className="about-nav-link">
            How it works
          </a>
          <a href="#principles" className="about-nav-link">
            Principles
          </a>
        </div>
      </nav>
        ...
        <div className="about-container about-hero-inner">
          <motion.div className="about-hero-left" {...fadeLeft()}>
            ...
            <p className="about-hero-sub">
              A free, all-in-one text workspace with <strong>{TOOLS.length}+</strong> tools for
            ...
            <div className="about-hero-actions">
              ...
              <a href="#features" className="about-cta-btn about-cta-btn--ghost">
                Explore Features
              </a>
            </div>
          </motion.div>
              ...
              <div className="about-mock-editor">
                ...
                <div className="about-mock-body">
                  <div className="about-mock-sidebar">
                    {['Fix Grammar', 'Paraphrase', 'Summarize', 'Translate', 'Format JSON'].map(
                      (t) => (
                        <span key={t} className="about-mock-tool">
                          {t}
                        </span>
                      )
                    )}
                  ...
                  <div className="about-mock-content">
                    ...
                    <div className="about-mock-output">
                      ...
                      <span className="about-mock-text about-mock-text--fixed">
        ...
        <section className="about-section about-section--bordered" id="features">
          <motion.div className="about-section-header" {...fade()}>
            ...
            <p className="about-section-sub">
              Powerful tools organized into one seamless, code-editor-style workspace
            </p>
          </motion.div>
