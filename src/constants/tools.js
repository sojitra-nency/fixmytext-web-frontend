...
export const TOOLS = [
  ...
  { id: 'rot13',         label: 'ROT13',         description: 'Shift each letter by 13 positions',       icon: 'R13', color: 'indigo',   group: 'encoding', tabs: ['transform','encode'],    type: 'api', endpoint: ENDPOINTS.ROT13,                  successMsg: 'ROT13 applied',               keywords: ['rot13','cipher','encode'] },
  ...
  { id: 'md5',           label: 'MD5',           description: 'Generate an MD5 hash of your text',       icon: '#5',  color: 'emerald', group: 'hashing', tabs: ['encode','code'],        type: 'local', handlerKey: 'handleMd5',                                          keywords: ['md5','hash'] },
