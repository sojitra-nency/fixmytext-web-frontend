...
export const TOOLS = [
  ...
  { id: 'lowercase',     label: 'Lowercase',    description: 'Convert all text to small letters',         icon: 'aa',  color: 'violet', group: 'case', tabs: ['transform','popular'], type: 'api', endpoint: ENDPOINTS.LOWERCASE,        successMsg: 'Converted to lowercase',     keywords: ['lower','small'] },
  ...
  { id: 'sentence_case', label: 'Sentence',     description: 'Capitalize only the first letter of each sentence', icon: 'Ss.', color: 'violet', group: 'case', tabs: ['transform'], type: 'api', endpoint: ENDPOINTS.SENTENCE_CASE,    successMsg: 'Converted to sentence case', keywords: ['sentence'] },
  ...
  { id: 'toggle_case',   label: 'Toggle',       description: 'Swap uppercase and lowercase letters',      icon: 'aA',  color: 'violet', group: 'case', tabs: ['transform'],           type: 'api', endpoint: ENDPOINTS.INVERSE_CASE,     successMsg: 'Case toggled',               keywords: ['toggle','swap','inverse'] },
  { id: 'uppercase',     label: 'UPPERCASE',    description: 'Convert all text to capital letters',       icon: 'AA',  color: 'violet', group: 'case', tabs: ['transform','popular'], type: 'api', endpoint: ENDPOINTS.UPPERCASE,        successMsg: 'Converted to uppercase',     keywords: ['upper','caps','capital'] },
  ...
  { id: 'no_breaks',     label: 'No Breaks',     description: 'Remove all line breaks from text',         icon: '↵✕',  color: 'slate', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_LINE_BREAKS,   successMsg: 'Line breaks removed',     keywords: ['line break','newline','remove'] },
  { id: 'strip_all',     label: 'Strip All',     description: 'Remove every space and whitespace',        icon: '✕⎵',  color: 'slate', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_ALL_SPACES,    successMsg: 'All spaces removed',      keywords: ['strip','all spaces'] },
  ...
  { id: 'trim_extra',    label: 'Trim Extra',    description: 'Remove extra spaces between words',        icon: '⎵→',  color: 'slate', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_EXTRA_SPACES,  successMsg: 'Extra spaces removed',    keywords: ['trim','space','extra','whitespace'] },
  ...
  { id: 'find_replace',  label: 'Find & Replace', description: 'Search and replace text patterns',       icon: '⌕↺',  color: 'teal', group: 'lines', tabs: ['transform','popular'],   type: 'drawer', panelId: 'find',                                                                    keywords: ['find','replace','search','regex'] },
  { id: 'number_lines',  label: 'Number',        description: 'Add line numbers to each line',           icon: '1.',   color: 'teal', group: 'lines', tabs: ['transform'],             type: 'api', endpoint: ENDPOINTS.NUMBER_LINES,           successMsg: 'Lines numbered',              keywords: ['number','lines','count'] },
  ...
  { id: 'reverse_lines', label: 'Rev Lines',     description: 'Reverse the order of all lines',          icon: '⇵',   color: 'teal', group: 'lines', tabs: ['transform'],             type: 'api', endpoint: ENDPOINTS.REVERSE_LINES,          successMsg: 'Lines reversed',              keywords: ['reverse','lines','order'] },
  ...
  // ──────────────── Encoding & Hashing ────────────────
  { id: 'base64_dec',    label: 'Base64 Dec',    description: 'Decode Base64 text back to normal',       icon: '64↓', color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.BASE64_DECODE,  successMsg: 'Base64 decoded',   keywords: ['base64','decode'] },
  { id: 'base64_enc',    label: 'Base64 Enc',    description: 'Encode text to Base64 format',            icon: '64↑', color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.BASE64_ENCODE,  successMsg: 'Base64 encoded',   keywords: ['base64','encode'] },
  { id: 'hex_dec',       label: 'Hex Dec',       description: 'Convert hexadecimal back to text',        icon: 'x0',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.HEX_DECODE,     successMsg: 'Hex decoded',      keywords: ['hex','decode'] },
  { id: 'hex_enc',       label: 'Hex Enc',       description: 'Convert text to hexadecimal',             icon: '0x',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.HEX_ENCODE,     successMsg: 'Hex encoded',      keywords: ['hex','hexadecimal','encode'] },
  { id: 'html_esc',      label: 'HTML Esc',      description: 'Escape HTML entities in text',            icon: 'H↑',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.HTML_ESCAPE,    successMsg: 'HTML escaped',     keywords: ['html','escape','entities'] },
  { id: 'html_unesc',    label: 'HTML Unesc',    description: 'Unescape HTML entities back to text',     icon: 'H↓',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.HTML_UNESCAPE,  successMsg: 'HTML unescaped',   keywords: ['html','unescape'] },
  { id: 'json_esc',      label: 'JSON Esc',      description: 'Escape special characters for JSON',      icon: 'J↑',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.JSON_ESCAPE,    successMsg: 'JSON escaped',     keywords: ['json','escape'] },
  { id: 'json_unesc',    label: 'JSON Unesc',    description: 'Unescape JSON special characters',        icon: 'J↓',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'api', endpoint: ENDPOINTS.JSON_UNESCAPE,  successMsg: 'JSON unescaped',   keywords: ['json','unescape'] },
  { id: 'md5',           label: 'MD5',           description: 'Generate an MD5 hash of your text',       icon: '#5',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'local', handlerKey: 'handleMd5',                                          keywords: ['md5','hash'] },
  { id: 'morse_dec',     label: 'Morse Dec',     description: 'Convert Morse code back to text',         icon: '—·',  color: 'indigo', group: 'encoding', tabs: ['encode'],               type: 'api', endpoint: ENDPOINTS.MORSE_DECODE,   successMsg: 'Morse decoded',    keywords: ['morse','decode'] },
  { id: 'morse_enc',     label: 'Morse Enc',     description: 'Convert text to Morse code',              icon: '·—',  color: 'indigo', group: 'encoding', tabs: ['encode'],               type: 'api', endpoint: ENDPOINTS.MORSE_ENCODE,   successMsg: 'Morse encoded',    keywords: ['morse','code','encode'] },
  ...
  { id: 'sha256',        label: 'SHA-256',       description: 'Generate a SHA-256 hash of your text',    icon: '#2',  color: 'indigo', group: 'encoding', tabs: ['encode','code'],        type: 'local', handlerKey: 'handleSha256',                                       keywords: ['sha','sha256','hash'] },
  ...
  // ──────────────── Developer Tools ────────────────
  { id: 'css_fmt',       label: 'CSS Fmt',       description: 'Format and prettify CSS code',            icon: '#:',  color: 'gray', group: 'developer', tabs: ['code'],                   type: 'local', handlerKey: 'handleFormatCss',                                     keywords: ['css','format','prettify'] },
  ...
  { id: 'html_fmt',      label: 'HTML Fmt',      description: 'Format and prettify HTML code',           icon: '<>',  color: 'gray', group: 'developer', tabs: ['code'],                   type: 'local', handlerKey: 'handleFormatHtml',                                    keywords: ['html','format','prettify'] },
  { id: 'js_fmt',        label: 'JS Fmt',        description: 'Format and prettify JavaScript code',     icon: 'JS',  color: 'gray', group: 'developer', tabs: ['code'],                   type: 'local', handlerKey: 'handleFormatJs',                                      keywords: ['javascript','js','format'] },
  ...
  { id: 'json_fmt',      label: 'JSON Fmt',      description: 'Format and prettify JSON data',           icon: '{}',  color: 'gray', group: 'developer', tabs: ['code','popular'],         type: 'api', endpoint: ENDPOINTS.FORMAT_JSON,    successMsg: 'JSON formatted',    keywords: ['json','format','prettify','beautify'] },
  ...
  { id: 'markdown',      label: 'Markdown',        description: 'Preview text as rendered Markdown',      icon: 'MD', color: 'indigo', group: 'developer', tabs: ['code'],                 type: 'action', handlerKey: 'handleMarkdownMode', keywords: ['markdown','preview','render'] },
  { id: 'regex_test',    label: 'Regex Test',    description: 'Test regular expressions on your text',   icon: '.*',  color: 'gray', group: 'developer', tabs: ['code'],                   type: 'drawer', panelId: 'regex',                                                 keywords: ['regex','regular expression','test','pattern'] },
  { id: 'ts_fmt',        label: 'TS Fmt',        description: 'Format and prettify TypeScript code',     icon: 'TS',  color: 'gray', group: 'developer', tabs: ['code'],                   type: 'local', handlerKey: 'handleFormatTs',                                      keywords: ['typescript','ts','format'] },

  // ──────────────── AI Writing ────────────────
  { id: 'eli5',          label: 'ELI5',           description: 'Explain text in simple, easy words',     icon: '5',   color: 'pink', group: 'ai_writing', tabs: ['writing','ai'],           type: 'ai', handlerKey: 'handleEli5',          keywords: ['eli5','explain','simple','easy'] },
  ...
  { id: 'fix_grammar',   label: 'Fix Grammar',    description: 'Automatically fix grammar mistakes',     icon: 'G',   color: 'pink', group: 'ai_writing', tabs: ['writing','ai','popular'], type: 'ai', handlerKey: 'handleFixGrammar',    keywords: ['grammar','fix','correct','spelling'] },
  ...
  { id: 'paraphrase',    label: 'Paraphrase',     description: 'Rewrite text with different words',      icon: '↻',   color: 'pink', group: 'ai_writing', tabs: ['writing','ai','popular'], type: 'ai', handlerKey: 'handleParaphrase',    keywords: ['paraphrase','rewrite','rephrase'] },
  ...
  { id: 'summarize',     label: 'Summarize',      description: 'Create a short summary of your text',    icon: 'Σ',   color: 'pink', group: 'ai_writing', tabs: ['writing','ai','popular'], type: 'ai', handlerKey: 'handleSummarize',     keywords: ['summarize','summary','shorten','brief'] },
  ...
  { id: 'change_tone',   label: 'Tone',           description: 'Change the tone of your writing',        icon: '♪',   color: 'pink', group: 'ai_writing', tabs: ['ai','writing'],           type: 'select', handlerKey: 'handleChangeTone', selectKey: 'toneSetting', setterKey: 'setToneSetting', options: [['formal','Formal'],['casual','Casual'],['friendly','Friendly']], keywords: ['tone','formal','casual','friendly'] },
  ...
  { id: 'gen_title',     label: 'Gen Title',      description: 'Generate catchy titles for your content', icon: 'H',   color: 'pink', group: 'ai_content', tabs: ['ai','writing'],          type: 'ai', handlerKey: 'handleGenerateTitle', keywords: ['title','generate','headline'] },
  ...
  { id: 'meta_desc',     label: 'Meta Desc',      description: 'Generate meta descriptions for SEO',     icon: 'M:',  color: 'pink', group: 'ai_content', tabs: ['ai'],                    type: 'ai', handlerKey: 'handleMetaDescriptions', keywords: ['meta','description','seo'] },
  ...
  { id: 'seo_titles',    label: 'SEO Titles',     description: 'Generate SEO-optimized title suggestions', icon: 'SEO', color: 'pink', group: 'ai_content', tabs: ['ai'],                  type: 'ai', handlerKey: 'handleSeoTitles',     keywords: ['seo','title','search','optimize'] },
  { id: 'sentiment',     label: 'Sentiment',      description: 'Analyze the emotional tone of text',     icon: '♡',   color: 'pink', group: 'ai_content', tabs: ['ai'],                    type: 'ai', handlerKey: 'handleSentiment',     keywords: ['sentiment','emotion','feeling','analyze'] },
  { id: 'tweet_shorten', label: 'Tweet Shorten',  description: 'Shorten text to fit in a tweet',         icon: '✂',   color: 'pink', group: 'ai_content', tabs: ['ai','popular'],           type: 'ai', handlerKey: 'handleTweetShorten',  keywords: ['tweet','shorten','twitter','x'] },

  // ──────────────── Language ────────────────
  { id: 'translate',     label: 'Translate',       description: 'Translate your text to another language', icon: 'A文', color: 'pink', group: 'language', tabs: ['language','ai','popular'], type: 'select', handlerKey: 'handleTranslate', selectKey: 'translateLang', setterKey: 'setTranslateLang', options: [['Spanish','Spanish'],['French','French'],['German','German'],['Hindi','Hindi'],['Chinese','Chinese'],['Japanese','Japanese'],['Korean','Korean'],['Portuguese','Portuguese'],['Italian','Italian'],['Arabic','Arabic'],['Russian','Russian'],['Dutch','Dutch'],['Turkish','Turkish'],['Bengali','Bengali']], keywords: ['translate','language','spanish','french','hindi','chinese'] },
  ...
  // ──────────────── Generate & Compare ────────────────
  { id: 'compare',       label: 'Compare',         description: 'Compare two texts side by side',         icon: '⇄',  color: 'purple', group: 'generate', tabs: ['transform'],             type: 'drawer', panelId: 'compare',    keywords: ['compare','diff','difference'] },
  { id: 'password',      label: 'Password',        description: 'Generate a strong random password',      icon: '⚿',  color: 'amber',  group: 'generate', tabs: ['transform','popular'],   type: 'drawer', panelId: 'password',   keywords: ['password','generate','random','security'] },
  ...
  // ──────────────── Utilities ────────────────
  { id: 'word_freq',     label: 'Word Freq',       description: 'Analyze word frequency in your text',    icon: 'W#', color: 'purple', group: 'utility',   tabs: ['writing'],              type: 'local', handlerKey: 'handleWordFrequency', keywords: ['word','frequency','count','analyze'] },
]
