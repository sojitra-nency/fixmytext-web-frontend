...
describe('DiffDrawer', () => {
    ...
    it('performs char_diff comparison', () => {
        ...
        expect(onResult).toHaveBeenCalledWith('Character Diff', expect.stringContaining('1 character difference'))
    ...
    it('performs text_overlap comparison', () => {
        ...
        expect(onResult).toHaveBeenCalledWith('Text Overlap', expect.stringContaining('the quick brown'))
    })
