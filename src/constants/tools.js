...
export const TOOLS = [
  ...
  // ──────────────── Whitespace ────────────────
  { id: 'no_accents',    label: 'No Accents',    description: 'Remove accent marks from characters',      icon: 'àa',  color: 'blush', group: 'whitespace', tabs: ['transform','language'],  type: 'api', endpoint: ENDPOINTS.REMOVE_ACCENTS,       successMsg: 'Accents removed',         keywords: ['accent','diacritic','normalize'] },
  { id: 'no_breaks',     label: 'No Line Breaks', description: 'Remove all line breaks from text',         icon: '↵✕',  color: 'blush', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_LINE_BREAKS,   successMsg: 'Line breaks removed',     keywords: ['line break','newline','remove'] },
  { id: 'strip_all',     label: 'Strip All Spaces', description: 'Remove every space and whitespace',        icon: '✕⎵',  color: 'blush', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_ALL_SPACES,    successMsg: 'All spaces removed',      keywords: ['strip','all spaces'] },
  { id: 'strip_html',    label: 'Strip HTML',    description: 'Remove all HTML tags from text',           icon: '</>',  color: 'blush', group: 'whitespace', tabs: ['transform','code'],     type: 'api', endpoint: ENDPOINTS.STRIP_HTML,           successMsg: 'HTML tags removed',       keywords: ['html','strip','tags','clean'] },
  { id: 'toggle_quotes', label: 'Toggle Quotes', description: 'Switch between smart and straight quotes', icon: '""',  color: 'blush', group: 'whitespace', tabs: ['transform'],             type: 'api', endpoint: ENDPOINTS.TOGGLE_SMART_QUOTES,  successMsg: 'Quotes toggled',          keywords: ['quotes','smart','curly'] },
  { id: 'trim_extra',    label: 'Trim Extra Spaces', description: 'Remove extra spaces between words',        icon: '⎵→',  color: 'blush', group: 'whitespace', tabs: ['transform'],            type: 'api', endpoint: ENDPOINTS.REMOVE_EXTRA_SPACES,  successMsg: 'Extra spaces removed',    keywords: ['trim','space','extra','whitespace'] },
