  ...
  return (
    <div
      className={`tu-shortcuts-row${recording ? ' tu-shortcuts-row--recording' : ''}${
        conflict ? ' tu-shortcuts-row--conflict' : ''
      }`}
    >
      <span className="tu-shortcuts-label">
        {sc.label}
        {isCustomized && !recording && (
          <span className="tu-shortcuts-edited" title="Customized">
            *
          </span>
        )}
      </span>
      ...
      {conflict && (
        <div className="tu-shortcuts-conflict">Conflicts with &quot;{conflict.label}&quot;</div>
      )}
    </div>
  );
}
        ...
        >
          ...
          >
              ...
              {conflict && pendingBinding && (
                ...
                >
                  <span className="tu-shortcuts-conflict-msg">
                    <b>{formatShortcut(pendingBinding).join(' + ')}</b> is already used by &quot;
                    <b>{conflict.label}</b>&quot;
                  </span>
                  <button
                    className="tu-shortcuts-conflict-btn tu-shortcuts-conflict-btn--cancel"
                    onClick={cancelRecording}
                  >
                    Cancel
                  </button>
                  <button
                    className="tu-shortcuts-conflict-btn tu-shortcuts-conflict-btn--override"
            ...
            <div className="tu-shortcuts-footer">
              Click a shortcut to rebind &middot; Press <kbd>Esc</kbd> to cancel &middot;{' '}
              <kbd>Ctrl</kbd>
              <kbd>/</kbd> to toggle
            </div>
          </motion.div>
