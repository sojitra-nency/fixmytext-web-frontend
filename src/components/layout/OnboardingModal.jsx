...
const PERSONA_META = {
  writer: {
    ...
    accent: '#C586C0',
    tools: ['Grammar', 'Paraphrase', 'Tone'],
    tagline: 'Craft words that resonate',
  },
  student: {
    gradient: 'linear-gradient(135deg, #4EC9B0 0%, #007ACC 100%)',
    accent: '#4EC9B0',
    tools: ['Summarize', 'ELI5', 'Translate'],
    tagline: 'Learn smarter, not harder',
  },
  developer: {
    gradient: 'linear-gradient(135deg, #569CD6 0%, #DCDCAA 100%)',
    accent: '#569CD6',
    tools: ['JSON', 'Regex', 'Encoding'],
    tagline: 'Parse, encode, transform',
  },
  social: {
    gradient: 'linear-gradient(135deg, #CE9178 0%, #F44747 100%)',
    accent: '#CE9178',
    tools: ['Hashtags', 'SEO', 'Tweet'],
    tagline: 'Content that gets clicks',
  },
  explorer: {
        ...
        <div className="tu-onboard-personas">
          {PERSONA_LIST.map((p, i) => (
            ...
            >
              ...
              <svg
                className="tu-onboard-persona-arrow"
                width="14"
                height="14"
                viewBox="0 0 24 24"
                fill="none"
