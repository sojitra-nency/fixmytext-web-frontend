...
describe('SmartSuggestions', () => {
  ...
  it('returns null when no suggestions', () => {
    const { container } = render(<SmartSuggestions suggestions={[]} onToolClick={vi.fn()} onDismiss={vi.fn()} />)
    expect(container.innerHTML).toBe('')
  })

  it('returns null when suggestions is null', () => {
    const { container } = render(<SmartSuggestions suggestions={null} onToolClick={vi.fn()} onDismiss={vi.fn()} />)
    expect(container.innerHTML).toBe('')
  })

  it('renders suggestion pills', () => {
    render(<SmartSuggestions suggestions={suggestions} onToolClick={vi.fn()} onDismiss={vi.fn()} />)
  ...
  it('calls onToolClick when pill clicked', () => {
    ...
    render(<SmartSuggestions suggestions={suggestions} onToolClick={onToolClick} onDismiss={vi.fn()} />)
  ...
  it('calls onDismiss when dismiss button clicked', () => {
    ...
    render(<SmartSuggestions suggestions={suggestions} onToolClick={vi.fn()} onDismiss={onDismiss} />)
